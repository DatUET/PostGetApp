package com.example.postgetapp.connectInternet;
...
public class DownloadJSON extends AsyncTask<String, Void, String> {
    ...
    public DownloadJSON(String link, List<HashMap<String, Object>> attrs) {
        this.link = link;
        this.attrs = attrs;
    }
    ...
    private String methodPost(HttpURLConnection connection)
    {
        ...
        try {
            ...
            {
                for(Map.Entry<String, Object> values : attrs.get(i).entrySet())
                {
                    key = values.getKey();
